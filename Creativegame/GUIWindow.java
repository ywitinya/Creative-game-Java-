...
public class GUIWindow extends JComponent implements KeyListener, MouseListener, Scrollable{
    ...
    public void preloadImages(ArrayList<String> imageFileNames){
        for (int i = 0; i < displayList.size(); i++){
            try{
                ...
                loadedImages.put(fname, readImage(fname));  
            }
            catch(RuntimeException re){
                //just in case... since students will be modifying the arraylist 
            }
    ...
    private void drawBackground(Graphics g){
        ...
        if (backgroundImage != null) {
            g.drawImage(backgroundImage, backImageX, 0, this.getWidth(), this.getHeight(),null);
            g.drawImage(backgroundImage, (getWidth() + backImageX), 0, this.getWidth(), this.getHeight(),null);
        }
        if (backImageX == -getWidth()-1) {
            backImageX = 0;
        }
    }
    ...
    public void setBackgroundImageX(int i) {
        backImageX = i;
    }
    ...
    @Override
    public void scroll() {
        setBackgroundImageX(getBackgroundImageX()+getScrollSpeed());
    }
